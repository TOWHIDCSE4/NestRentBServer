...
export class ContractService {
    ...
    async updateContract(id: number, updateContractDto: UpdateContractDto, userPhoneNumber: string): Promise<any> {
            ...
            contract.images_deposit = updateContractDto.imagesDeposit || contract.images_deposit;
